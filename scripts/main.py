...
class PredictTool:
    ...
    def find_train_best_network(self, network_config, reverse_dictionary, train_data, train_labels, test_data, test_labels, n_epochs, class_weights, usage_pred, standard_connections):
        ...
        best_params, best_model = hyper_opt.train_model(network_config, reverse_dictionary, train_data, train_labels, test_data, test_labels,  class_weights)

        # define callbacks
        print("Start evaluating on the best model...")
